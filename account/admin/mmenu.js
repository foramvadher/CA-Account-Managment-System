...
function dmenu(mnu){
	...
	if(_d.layers)_d.write("<layer z-index=0 id=menuback"+mnu+" top="+(menu[1]-m14h)+" height=2 width="+m14w+" left=0 bgcolor="+hlp[1]+"></layer>");else	_d.write("<div id=menuback"+mnu+" style=\"position:absolute;top:"+(menu[1]-m14h)+"px;width:"+m14w+";height:2px;background:"+hlp[1]+"\">&nbsp;</div>")}
	...
	if(ns4)
	{
		...
		mt="<layer "+m18+" z-index=0 visibility=hidden "+bgc+" id="+mnu+" top="+menu[1]+" left="+menu[2]+" width="+thw+">"
	...
	else
	{
		...
		if(ie55){ifBlnk="";if(location.protocol=="https:")ifBlnk="/blank.htm";mt="<IFRAME frameborder=0 id=if"+mnu+" src=\""+ifBlnk+"\" scroll=none style=\"FILTER:progid:DXImageTransform.Microsoft.Alpha(style=0,opacity=0);visibility:hidden;height:20;position:absolute;width:"+(menu[3]+ns6w)+"px;left:"+dmleft+"px;top:"+menu[1]+"px;z-index:0\"></iframe>"}
		mt+="<div tabindex=1 id="+mnu+" style=\""+iedf+scrof+";z-index:0;visibility:hidden;"+brd+"position:absolute;background:"+m18+hlp[1]+";width:"+(menu[3]+ns6w)+"px;left:"+dmleft+"px;top:"+menu[1]+"px;\">"
